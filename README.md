# Traductor Automático de Modales de la Historia Victoriana
...
The Traductor Automático de Modales de la Historia Victoriana investigates potential improvements to machine translation through two key innovations:
...
│   ├── hvm/                        # Historia victoriana domain
│   │   ├── eng/                    # English content
│   │   │   ├── submissions/        # Source files
│   │   │   ├── processed/          # JSON files (hvm-eng_item001.json, etc.)
│   │   │   └── hvm-eng_database.json
│   │   └── esp/                    # Spanish content  
│   │       ├── submissions/        # Source files        
│   │       ├── processed/          # JSON files (hvm-esp_item001.json, etc.)
│   │       └── hvm-esp_database.json
...
│   └── hvm/                        # Vectors for HVM domain
│       ├── hvm-document-vectors.json   # Document-level vectors
│       ├── hvm-section-vectors.json    # Section-level vectors
│       └── hvm-paragraph-vectors.json  # Paragraph-level vectors
...
#### 2. Build Your Corpus
Follow the examples in `corpora/hvm/` to create your domain-specific corpus:

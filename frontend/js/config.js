...
const repoName = 'Traductor-automatico-historia-victoriana'; // Update this to match your actual repo name
...
export const CORPUS = {
  // Domain currently implemented: Historia Victoriana
  DOMAIN: 'hvm', // Update this to match your domain code
  
  // Vector file paths (dynamic for both local and GitHub Pages environments)
  // Update these to match your file paths and names
  VECTOR_PATHS: {
    document: `${basePath}/vectors/hvm/hvm-document-vectors.json`,
    section: `${basePath}/vectors/hvm/hvm-section-vectors.json`, 
    paragraph: `${basePath}/vectors/hvm/hvm-paragraph-vectors.json`
  },
  
  // Database paths (dynamic for both local and GitHub Pages environments)
  // Update these to match your file paths and names
  DATABASE_PATHS: {
    en: `${basePath}/corpora/hvm/eng/hvm-eng_database.json`,
    es: `${basePath}/corpora/hvm/esp/hvm-esp_database.json`
  }
};
